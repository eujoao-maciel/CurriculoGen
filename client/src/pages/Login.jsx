    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-600">
            <form
                ...
                className="relative w-[300px] md:w-[350px] text-center border border-black rounded-2xl px-8 bg-gray-400"
            >
                <Link to="/" className="absolute top-3 left-3" >
                    <ArrowLeft className="size-5 text-slate-600 hover:text-slate-700" />
                </Link>
