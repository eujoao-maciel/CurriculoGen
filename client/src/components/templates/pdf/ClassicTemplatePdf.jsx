...
export const ClassicTemplatePdf = ({ data, accentColor = '#3B82F6' }) => {
            ...
            >
               ...
               <View style={styles.contactContainer}>
                  ...
                  {personalInfo.location && (
                     <Text>Local: {String(personalInfo.location)}</Text>
                  )}

                  {personalInfo.linkedin && (
                     <Text>LinkedIn: {String(personalInfo.linkedin)}</Text>
                  )}

                  {personalInfo.website && (
                     <Text>Site: {String(personalInfo.website)}</Text>
                  )}
               </View>
            </View>
