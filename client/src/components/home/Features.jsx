                     ...
                     <div className="space-y-2">
                        ...
                        <p
                           className="
                                    ...
                                    "
                        >
                           Informe seus dados passo a passo e deixe que a
                           plataforma organize tudo da forma correta.
                        </p>
                     </div>
                  </div>
               </div>
                     ...
                     <div className="space-y-2">
                        ...
                        <p
                           className="
                                    ...
                                    "
                        >
                           Escolha entre layouts modernos e bem estruturados,
                           pensados para processos seletivos reais.
                        </p>
                     </div>
                  </div>
               </div>
                     ...
                     <div className="space-y-2">
                        ...
                        <p
                           className="
                                    ...
                                    "
                        >
                           Gere seu currículo pronto para envio ou impressão,
                           sem complicações.
                        </p>
                     </div>
                  </div>
